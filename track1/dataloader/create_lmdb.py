...
if __name__ == '__main__':
    image_root = r'F:\lhc\ABAW4\MTL\dataset\test_aligned'
    lmdb_save_path = os.path.join(r'F:\lhc\ABAW4\MTL\dataset', 'test_aligned_lmdb/.croped_jpeg')  # must end with .lmdb
    ...
    data_size = int(image_nbyte * num_image * 1.7)
