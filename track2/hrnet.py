...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, num_modules, num_branches, block, 
        ...
        #print(pre_stage_channels) [18, 36, 72, 144]
...
class HighResolutionCLSNet(nn.Module):

    def __init__(self, backbone, pre_stage_channels=[18, 36, 72, 144], classify=True,**kwargs):
        super(HighResolutionCLSNet, self).__init__()
...
def hrnet18(pretrain_path=None, classify = False,**kwargs):
    hrnet_backbone = HighResolutionNet(
        num_modules = [1, 1, 4, 3],
    ...
    model = HighResolutionCLSNet(hrnet_backbone,classify = False)
    if pretrain_path:
